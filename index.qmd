...
A time series plot is displayed below to visualize how the 4 proposed variables vary throughout the past 12 years starting from March 2011 to December 2022, including 48 quarterly observations of year on year changes. 
...
\begin{align}
X = \begin{bmatrix}
1 & \color{Red} y_{1,0} & \color{Red}\cdots & \color{Red}y_{1,1-P}, & y_{2, 0} &\cdots & y_{1,1-P}, & y_{3, 0} &\cdots & y_{3, 1-P},& y_{4, 0} & \cdots & y_{4, 1-P}\\
